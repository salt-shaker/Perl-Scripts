...
my $text_area1 =
  $mw->Scrolled( "Text", -width => 70, -height => 45, -wrap => 'none' )
  ->pack( -side => 'right', -padx => '10' );

#my $text_area5 = $mw-> Scrolled("Text",-width=>70, -height=>20, -wrap => 'none')->pack(-side => 'top', -side=> 'right', -padx => '10');
...
my $label_area_1 = $mw->Label( -text => "$widgit_1_lable . $widgit_1_label_p2" )
  ->pack( -anchor => 'nw' );
my $lb = $mw->Scrolled(
    "Listbox",
    -selectmode => "single",
...
my $ent_area_2 =
  $mw->Entry( -width => 80 )->pack( -padx => '10', -anchor => 'nw' );
...
my $text_area_lable = $mw->Label( -text => "$widgit_7_lable" )
  ->pack( -padx => '10', -anchor => 'nw' );
my $text_area2 =
  $mw->Scrolled( "Text", -width => 70, -height => 10, -wrap => 'none' )
  ->pack( -anchor => 'nw' );
...
$mw->Button(
    -text    => "Save Changes Current Log File",
    -width   => 80,
    -command => sub {
...
$mw->Button(
    -text    => "Refresh Current Log File",
    -width   => 80,
    -command => sub { &f_open }
)->pack( -padx => '10', -pady => '1', -anchor => 'nw' );

#Exit button
$mw->Button( -text => "Exit", -width => 80, -command => sub { exit } )
  ->pack( -padx => '10', -pady => '1', -anchor => 'nw' );
my $label_fill_2 = $mw->Label( -text => "", -width => 80 )
  ->pack( -padx => '10', -anchor => 'nw' );
